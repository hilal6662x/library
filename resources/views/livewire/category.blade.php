<div>
    ...
    <a
        class="flex items-center justify-between p-4 mb-8 mt-8 text-sm font-semibold text-purple-100 bg-blue-500 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
        <div class="flex items-center">
            <span>{{ __('Category ') }} {{ __($totalCategory) }}</span>
        </div>
        <span>
            <button
                class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-500 border-transparent rounded-lg active:bg-blue-800 hover:bg-blue-800 focus:outline-none focus:shadow-outline-blue"
                wire:click="showForm">
                Create Category
            </button>
        </span>
    ...
    @if ($createForm == true)
        {{-- create-Category --}}
        <button
            class="px-4 py-2 my-2 text-sm font-semibold leading-5 text-black transition-colors duration-150 bg-black-600 border border-transparent rounded-lg active:bg-blue-500 hover:bg-blue-500 focus:outline-none focus:shadow-outline-blue"
        ...
        <form action="" wire:submit.prevent="store">
            ...
            <button
                class="px-4 py-2 my-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-500 border border-transparent rounded-lg active:bg-blue-800 hover:bg-blue-800 focus:outline-none focus:shadow-outline-purple"
                type="submit">
                Save
            </button>
        </form>
    ...
    @if ($updateForm == true)
        ...
        <form action="" wire:submit.prevent="update({{ $category_id }})">
            ...
            @enderror
            <button
                class="px-4 py-2 my-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-500 border border-transparent rounded-lg active:bg-blue-800 hover:bg-blue-800 focus:outline-none focus:shadow-outline-blue"
                type="submit">
                Update Category
            </button>
        </form>
