<div>
    ...
    <a
        ...
        <span>
            <button
                class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-500 border border-transparent rounded-lg active:bg-blue-800 hover:bg-blue-800 focus:outline-none focus:shadow-outline-blue"
                wire:click="showForm">
                Issue Book
            </button>
        </span>
